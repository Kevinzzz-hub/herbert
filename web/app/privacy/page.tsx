...
export const metadata: Metadata = {
  title: "隐私与数据 | Herbert",
  description: "了解 Herbert 如何处理 PDF、学习记录、登录信息与用户自己的 AI API Key。",
  openGraph: {
    title: "隐私与数据 | Herbert",
    ...
    <main className="policy-shell">
      ...
      <article className="policy-page">
        ...
        <section className="data-map" aria-label="Herbert 数据流">
          ...
          <article><span>02</span><h2>保存在 Supabase</h2><p>登录邮箱、账号标识、AI 服务商和模型设置保存在 Supabase；API Key 单独进入加密保险箱。Herbert 不保存密码。</p><strong>网页只显示 Key 的末尾四位</strong></article>
          <article><span>03</span><h2>发送给 AI 服务商</h2><p>生成总结时发送提取文字；课程问答只发送本地选出的相关片段。模型费用计入用户选择的服务商账户。</p><strong>原始 PDF 文件不会发送</strong></article>
        </section>
        ...
        <section className="policy-details">
          <div>
            ...
            <ul>
              ...
              <li>课程问答最多向当前 AI 服务发送 10 个相关页面片段，共不超过 18,000 个字符。</li>
          ...
          <div>
            ...
            <ul>
              ...
              <li>在“管理 AI”中更换服务商、模型，或替换和删除 API Key。</li>
